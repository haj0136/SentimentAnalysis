...
using SentimentAnalysis1ML.Model.DataModels;
using Microsoft.ML.Trainers;

namespace SentimentAnalysis1ML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Marek\source\repos\SentimentAnalysis\BinaryClassification\SentimentAnalysisProject\bin\x64\Debug\Data\imdb_labelled.tsv";
        private static string MODEL_FILEPATH = @"../../../../SentimentAnalysis1ML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.AveragedPerceptron(new AveragedPerceptronTrainer.Options() { LearningRate = 01f, DecreaseLearningRate = false, L2Regularization = 0001413571f, NumberOfIterations = 89, InitialWeightsDiameter = 9865971f, Shuffle = false, LabelColumnName = "Label", FeatureColumnName = "Features" });
